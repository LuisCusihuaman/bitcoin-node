...
pub struct PayloadGetBlocks {
    pub version: u32,
    pub hash_count: usize,            // TODO Variable size
    pub block_header_hashes: Vec<u8>, // TODO Variable size
...
impl PayloadGetBlocks {
    pub fn size(&self) -> u64 {
        ...
        size += 4; // version
        size += hash_count_bytes.len(); // TODO Variable size
        size += self.block_header_hashes.len(); // TODO Variable size
